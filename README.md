...
sales_data.csv # Original raw dataset
    src
      data_cleaning.py # Python script for cleaning data
    reflection.md # Reflection on project experience
...
Run data and clean script: 
python3 src/data_cleaning.py

Learned Outcomes: 
I gained expereince with github, visual studio, and praticed my python skills 

I learned how to clean data and handle missing values 

I practiced and learned collaberation workflow between the data, and all the different programs I was using 
